...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand"><h4 style="color:blue">CLER´S - USUARIO</h4></a>
    <p></p>
   ...
   try
   {
    ...
    <h5>Datos del colaborador:</h5>
        <div class="card border-dark mb-3">
            ...
            <form class="form-control" action="registerClersUser.php" method="GET">
            ...
            <label for="floatingInput" style="color: blue;">Nuevos puntos</label>
            </div>
            </div>


            <div class="col mb-3">
                <button class="btn btn-outline-success" name="saveData">Guardar</button>
            </div>
            </div>
            </form>
            <br>
