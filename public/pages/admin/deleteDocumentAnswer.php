...
try{
    ...
    $datosColaborador = json_decode(file_get_contents("http://localhost:3000/collaborator/$numberCollaborator"), true);
    $idCollaborator = $datosColaborador['_id'];

    $datos = json_decode(file_get_contents("http://localhost:3000/$idCollaborator/deleteDocument/$idDocument"), true);
        ...
        if($datos){
            ...
            <body>
                ...
                <script>Swal.fire({
                    ...
                    text: 'Se elimino el documento correctamente',
