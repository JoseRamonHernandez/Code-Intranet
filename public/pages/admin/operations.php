...
<td class="text-center"><a href="editOperation.php?idOperation=<?php echo $getOperations[$a]['_id']; ?>" style="text-decoration:none; color: yellow;" title="Editar"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
