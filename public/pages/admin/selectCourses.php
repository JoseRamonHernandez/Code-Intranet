...
<div class="card" style=" width: 15rem;">
  ...
  <div class="card-body">
    ...
    <a href="downloadFileAdmin.php?nameFile='.$element['name'].'&nameCourse='.$nameCourse.'&idCourse='.$idCourse.'&idCategorie='.$idCategorie.'&nameCategorie='.$nameCategorie.'" class="btn btn-primary"> Ver </a>
