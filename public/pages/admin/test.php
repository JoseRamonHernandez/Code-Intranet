...
foreach ($questions['questions'] as $question) {
    ...
    <td><a>Icon Edit</a></td>
    <td class="text-center"><a href="deleteQuestion.php?textQuestion='.$question['question_text'].'&idQuestion='.$question['_id'].'&idCourse='.$idCourse.'&idCategorie='.$idCategorie.'&nameCategorie='.$nameCategorie.'&nameCourse='.$nameCourse.'" style="text-decoration:none; color:red;" title="Eliminar"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
